...
import { PiSortDescending, PiFile, PiSquaresFour, PiTrashSimpleLight, PiPencilSimpleLineDuotone } from 'react-icons/pi'; 
			...
			<div className='w-full'>
				<div className='w-full flex flex-row justify-between items-center'>
					...
					<div className='flex flex-row items-center gap-2'>
						{isMapView ? (
							...
							<BsToggleOn size={24} color="#4185C6" onClick={() => setIsMapView(!isMapView)} />
						)}
						
						<div className="text-black text-lg font-medium font-['SF Pro Display'] leading-tight">Map View</div>
					</div>
				</div>
				<div className='h-6' />
				<div className='flex flex-row items-center justify-between'>
					...
					<div className='flex flex-row items-center justify-between'>
						...
						<div
							className="w-14 h-14 px-4 pt-[15.50px] pb-[16.50px] bg-white rounded-2xl border border-zinc-100 justify-center items-center inline-flex">
							<div className="w-6 h-6 justify-center items-center inline-flex">
								{
									listView === 'list' ? (
										<PiSquaresFour size={24} onClick={() => setListView('grid')} />
									) : (
					...
					listView === 'list' ? (
						...
						<div className='w-full grid grid-cols-2 gap-2'>
							{data.map(o => (
								...
								<div className="w-full h-[169px] grid grid-cols-3 p-4 relative bg-white rounded-2xl border border-zinc-100">
									<div className="flex-col justify-start items-start gap-2 inline-flex">
										<div className="justify-start items-center gap-2 inline-flex">
											<div className="text-neutral-500 text-base font-normal font-['SF Pro Display'] leading-tight">Session Name</div>
										</div>
										<div className="text-stone-950 text-base font-normal font-['SF Pro Display'] leading-tight">Troy Northwestern</div>
									</div>
									<div className="flex-col justify-start items-start gap-2 inline-flex">
										<div className="text-neutral-500 text-base font-normal font-['SF Pro Display'] leading-tight">Connectors</div>
										<div className="text-stone-950 text-base font-normal font-['SF Pro Display'] leading-tight">345</div>
									</div>
									<div className="flex-col justify-start items-start gap-2 inline-flex">
										<div className="text-neutral-500 text-base font-normal font-['SF Pro Display'] leading-tight">Session Duration</div>
										<div className="text-stone-950 text-base font-normal font-['SF Pro Display'] leading-tight">09:00-10:00PM</div>
									</div>
									<div className="flex-col justify-start items-start gap-2 inline-flex">
										<div className="text-neutral-500 text-base font-normal font-['SF Pro Display'] leading-tight">Status</div>
										<div className="w-[82px] px-2 py-1.5 bg-emerald-500 bg-opacity-10 rounded-[100px] justify-center items-center gap-2.5 inline-flex">
											<div className="justify-center items-center gap-0.5 flex">
												<div className="text-emerald-500 text-sm font-normal font-['SF Pro Display'] leading-[17px]">Working</div>
									...
									<div className="flex-col justify-start items-start gap-2 inline-flex">
										<div className="text-neutral-500 text-base font-normal font-['SF Pro Display'] leading-tight">Energy Consumed</div>
										<div className="text-stone-950 text-base font-normal font-['SF Pro Display'] leading-tight">36 KWh</div>
									</div>
									<div className="justify-start items-center gap-2 inline-flex">
